...
private:
    ...
    /// Ile \ref Glon "glonów" aktualnie żyje w tym środowisku.
    /// \see Organizm::czyZywy()
    unsigned int iloscGlonow;

    /// Ile \ref Grzyb "grzybów" aktualnie żyje w tym środowisku.
    /// \see Organizm::czyZywy()
    unsigned int iloscGrzybow;

    /// Ile \ref Bakteria "bakterii" aktualnie żyje w tym środowisku.
    /// \see Organizm::czyZywy()
    unsigned int iloscBakterii;

    /// Ile martwych organizmów aktualnie znajduje się w środowisku.
    /// \see Organizm::czyZywy()
    ...
    /// \brief Sprawdza, czy organizm nadal żyje.
...
public:
    ...
    /// \brief Struktura przechowująca opcje dla funkcji Srodowisko::wyswietlSrodowisko(ustWysw).
    ...
    /// \brief Zwraca wartość z tablicy #ustWyswietlania->wyswietlajInfo
    /// z indeksu odpowiadającego \ref Organizm "organizmowi" o danym znaku.
    ...
    /// \brief Zwraca wartość z tablicy #ustWyswietlania->wyswietlajNajedzenie
    /// z indeksu odpowiadającego \ref Organizm "organizmowi" o danym znaku.
    /// \param[in] znakOrganizmu Znak \ref Organizm "organizmu".
    ...
    /// \brief Zwraca wartość z tablicy #ustWyswietlania->wyswietlajRozmnozenie
    /// z indeksu odpowiadającego \ref Organizm "organizmowi" o danym znaku.
    /// \param[in] znakOrganizmu Znak \ref Organizm "organizmu".
    ...
    /// \brief Pyta użytkownika o konfigurację siebie
    ...
    /// \brief Udostępnia użytkownikowi interfejs obsługi
